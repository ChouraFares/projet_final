                ...
                <tbody>
                    ...
                    @foreach($factures as $facture)
                        @php
                            ...
                            $isTransitValidated = in_array($facture->validation_transit, ['Validé', 'Validé par DG']);
                        @endphp
                        <tr>
                            <td class="{{ $groupClass }}">
                            ...
                            @foreach($sections as $section)
                                ...
                                @if($facture->{$section.'_preparer_paiement'})
                                    <td>
                                        <a href="{{ route('facture.complimentaire.thon.cheques', ['id' => $facture->id, 'type' => $section]) }}" 
