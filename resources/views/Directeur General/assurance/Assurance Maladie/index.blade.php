...
<div class="container">
    ...
    <div class="btn-group-container">
        ...
        <a href="{{ route('directeur-general.assurance-maladie.contrats') }}" class="btn btn-success">
            <i class="fas fa-file-contract"></i> Gestion des Contrats
        </a>

        <!-- Lien vers le suivi des sinistres -->
        <a href="{{ route('directeur-general.assurance-maladie.bordereaux') }}" class="btn btn-warning">
