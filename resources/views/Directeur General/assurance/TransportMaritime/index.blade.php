...
<div class="container">
    ...
    <div class="btn-group-container">
        <a href="{{ route('directeur-general.transport-maritime.contrats') }}" class="btn btn-success">
            <i class="fas fa-file-contract"></i> Gestion des Contrats
        </a>
        <a href="{{ route('directeur-general.transport-maritime.sinistres') }}" class="btn btn-warning">
