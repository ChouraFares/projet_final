...
<div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; text-align: center;">
    <h1 style="color: #1a73e8; font-size: 24px; margin: 0;">Nouvelle demande de prépaiement</h1>
</div>
...
<p style="font-size: 16px; color: #333;">
    Une nouvelle demande de prépaiement a été soumise. Voici les détails :
</p>
...
<table style="width: 100%; max-width: 600px; margin: 20px auto; border-collapse: collapse; font-size: 16px; color: #333;">
    <tr style="background-color: #e9ecef;">
        ...
        <td style="padding: 10px; border: 1px solid #dee2e6;">{{ $facture->facture }}</td>
    </tr>
    <tr>
...
<!-- Closing -->
<p style="font-size: 16px; color: #333; margin-top: 20px;">
    Merci de vérifier cette demande dans le tableau de bord.
</p>
