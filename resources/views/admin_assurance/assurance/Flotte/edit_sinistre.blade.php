...
<div class="container">
    ...
    <form action="{{ route('admin.assurance.flotte.sinistres.update', $sinistre->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="text" name="sinistre_num" class="form-control" value="{{ old('sinistre_num', $sinistre->sinistre_num) }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" name="date_sinistre" class="form-control" value="{{ old('date_sinistre', $sinistre->date_sinistre) }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="situation_dossier" class="form-control" required>
                <option value="">Sélectionnez une option</option>
                <option value="Avant Constat" {{ old('situation_dossier', $sinistre->situation_dossier) == "Avant Constat" ? 'selected' : '' }}>Avant Constat</option>
                <option value="Constat Déposé" {{ old('situation_dossier', $sinistre->situation_dossier) == "Constat Déposé" ? 'selected' : '' }}>Constat Déposé</option>
                <option value="Expert" {{ old('situation_dossier', $sinistre->situation_dossier) == "Expert" ? 'selected' : '' }}>Expert</option>
                <option value="En Attente Du Remboursement" {{ old('situation_dossier', $sinistre->situation_dossier) == "En Attente Du Remboursement" ? 'selected' : '' }}>En Attente Du Remboursement</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" name="date_cloture_dossier" class="form-control" value="{{ old('date_cloture_dossier', $sinistre->date_cloture_dossier) }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="Expert" class="form-Expert" value="{{ old('reglement', $sinistre->Expert) }}" required>
        </div>
