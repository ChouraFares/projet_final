...
<div class="container">
    ...
    <div class="btn-group-container">
        ...
        <a href="{{ route('admin.assurance.flotte.index') }}" class="btn btn-success">
            <i class="fas fa-file-contract"></i> Gestion des Contrats
        </a>

        <!-- Lien vers le suivi des sinistres -->
        <a href="{{ route('admin.assurance.flotte.sinistres') }}" class="btn btn-warning">
            <i class="fas fa-clipboard-list"></i> Suivi des Sinistres
        </a>

        <!-- Lien vers la déclaration des sinistres -->
        <a href="{{ route('admin.assurance.flotte.sinistres.create') }}" class="btn btn-danger">
