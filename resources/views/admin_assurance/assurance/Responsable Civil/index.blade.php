...
<div class="container">
    ...
    <div class="btn-group-container">
        <a href="{{ route('admin.assurance.ResponsableCivil.contrats') }}" class="btn btn-success">
            <i class="fas fa-file-contract"></i> Gestion des Contrats
        </a>
        <a href="{{ route('admin.ResponsableCivil.sinistres.contrats') }}" class="btn btn-warning">
            <i class="fas fa-exclamation-triangle"></i> Suivi des Sinistres
        </a>
        <a href="{{ route('create_ResponsableCivil_sinistres') }}" class="btn btn-danger">
            <i class="fas fa-file-alt"></i> Déclaration des Sinistres
        </a>
    </div>
</div>
