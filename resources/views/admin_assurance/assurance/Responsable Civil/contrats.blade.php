...
<style>
    ...
    .btn-primary i {
        margin-right: 5px; /* Gardé de votre style existant */
    }
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('admin.assurance.ResponsableCivil.create') }}" class="btn btn-primary btn-lg">
            ...
            @foreach($contrats as $contrat)
                <tr>
                    ...
                    <td class="actions-column">
                        <a href="{{ route('Responsable_Civil.edit', $contrat->id) }}" class="btn btn-warning btn-sm mb-2">
                            <i class="fas fa-edit"></i> Modifier
                        </a>
                        <form action="{{ route('ResponsableCivilDestroy', $contrat->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce contrat ?');">
                            @csrf
                            @method('DELETE')
            ...
            buttons: [
                {
                    ...
                    exportOptions: {
                        columns: ':not(.no-export)' // Exclure les colonnes marquées "no-export"
                    }
                },
                {
                    extend: 'pdfHtml5',
                    ...
                    customize: function(doc) {
                        doc.content[1].table.widths = ['15%', '15%', '15%', '15%', '10%', '10%', '10%']; // Ajustement des largeurs
                        doc.styles.tableHeader.fontSize = 10; // Taille ajustée pour lisibilité
