...
<style>
    ...
    #contratsTable th, #contratsTable td {
        padding: 12px 15px;
        text-align: center;
    ...
    #contratsTable thead th {
        background-color: #343a40; /* Gris foncé pour l'en-tête */
        color: white;
        font-weight: bold;
    }

    #contratsTable tbody tr:nth-child(even) {
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('BrisDeMachineCreate') }}" class="btn btn-primary btn-lg">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions-column">
                    <a href="{{ route('EditBrisDeMachine', $contrat->id) }}" class="btn btn-warning btn-sm mb-2">
                        <i class="fas fa-edit"></i> Modifier
                    </a>
                    <form action="{{ route('BrisDeMachineDestroy', $contrat->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce contrat ?');">
                        @csrf
                        @method('DELETE')
