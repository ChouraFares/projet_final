...
<div class="dashboard">
    <div class="header">
        <div>
            <h2><i class="fas fa-tools me-2"></i>Modifier le Sinistre Bris de Machine</h2>
        </div>
    </div>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('bris_de_machine.update', $sinistre->id) }}" method="POST" id="editSinistreBrisMachineForm">
            @csrf
            @method('PUT')
                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('assureur') is-invalid @enderror" 
                               ...
                               value="{{ old('assureur', $sinistre->assureur) }}" required>
                        @error('assureur')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nature_sinistre') is-invalid @enderror" 
                               ...
                               value="{{ old('nature_sinistre', $sinistre->nature_sinistre) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('lieu_sinistre') is-invalid @enderror" 
                               ...
                               value="{{ old('lieu_sinistre', $sinistre->lieu_sinistre) }}" required>
                        @error('lieu_sinistre')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('degats') is-invalid @enderror" 
                                  ...
                                  rows="4" required>{{ old('degats', $sinistre->degats) }}</textarea>
                        @error('degats')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('charge') is-invalid @enderror" 
                               ...
                               value="{{ old('charge', $sinistre->charge) }}" required>
                        @error('charge')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control @error('perte') is-invalid @enderror" 
                               id="perte" name="perte" 
                               value="{{ old('perte', $sinistre->perte) }}" required>
                        @error('perte')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('responsable') is-invalid @enderror" 
                               ...
                               value="{{ old('responsable', $sinistre->responsable) }}" required>
                        @error('responsable')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('statu_du_dossier') is-invalid @enderror" 
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('commentaires') is-invalid @enderror" 
                                  ...
                                  rows="4">{{ old('commentaires', $sinistre->commentaires) }}</textarea>
                        @error('commentaires')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
...
<script>
    ...
    document.getElementById('editSinistreBrisMachineForm').addEventListener('submit', function(e) {
