...
<div class="dashboard">
    <div class="header">
        <div>
            <h2><i class="fas fa-tools me-2"></i>Créer un Contrat d'Assurance Bris de Machine</h2>
        </div>
    </div>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('BrisDeMachineStore') }}" method="POST" enctype="multipart/form-data" id="createBrisMachineForm">
            @csrf
            ...
            <div class="btn-group" style="margin-top: 30px; justify-content: center;">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>Créer Contrat
                </button>
            </div>
        </form>
    </div>
...
<script>
    ...
    document.getElementById('createBrisMachineForm').addEventListener('submit', function(e) {
