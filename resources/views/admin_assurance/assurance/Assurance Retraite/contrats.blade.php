...
<style>
    ...
    #contractsTable th, #contractsTable td {
        ...
        font-size: 14px;
        max-width: 150px; /* Conservé de votre style existant */
        overflow: hidden;
    ...
    .btn {
        ...
        display: inline-block !important; /* Conservé de votre style existant */
    }
    ...
    /* Colonne Actions */
    .actions-column {
        width: 100px !important; /* Réduit de 300px à 100px pour cohérence avec les autres vues */
        min-width: 100px;
        white-space: nowrap;
        text-align: center;
        display: flex;
        flex-direction: column; /* Conservé de votre structure HTML */
        align-items: center;
    }

    .actions-column .btn {
        margin: 5px 0; /* Ajusté pour espacement vertical */
    }
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('admin.assurance.AssuranceRetraite.create') }}" class="btn btn-primary btn-lg">
                ...
                <tr>
                    ...
                    <td class="actions-column">
                        <div class="d-flex flex-column">
                            <a href="{{ route('AssuranceRetraite.edit', $contrat->id) }}" class="btn btn-warning btn-sm mb-2">
                                <i class="fas fa-edit"></i> Modifier
                            </a>
                            <form action="{{ route('AssuranceRetraiteDestroy', $contrat->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce contrat ?');">
                                @csrf
                                @method('DELETE')
            ...
            buttons: [
                {
                    ...
                    exportOptions: {
                        columns: ':not(:nth-child(8)):not(:nth-child(9)):not(:last-child)' // Exclure Attachement Contrat, Attachement Avenant et Actions
                    }
                },
                {
                    extend: 'pdfHtml5',
