...
<div class="container">
    ...
    <form action="{{ route('admin.mrd.sinistres.store') }}" method="POST">
        @csrf
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="compagnie_assurance" name="compagnie_assurance" class="form-control @error('compagnie_assurance') is-invalid @enderror" value="{{ old('compagnie_assurance') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="fournisseur" name="fournisseur" class="form-control @error('fournisseur') is-invalid @enderror" value="{{ old('fournisseur') }}">
                    @error('fournisseur')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nature_sinistre" name="nature_sinistre" class="form-control @error('nature_sinistre') is-invalid @enderror" value="{{ old('nature_sinistre') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="lieu_sinistre" name="lieu_sinistre" class="form-control @error('lieu_sinistre') is-invalid @enderror" value="{{ old('lieu_sinistre') }}">
                    @error('lieu_sinistre')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="date_sinistre" name="date_sinistre" class="form-control @error('date_sinistre') is-invalid @enderror" value="{{ old('date_sinistre') }}">
                    @error('date_sinistre')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <textarea id="degats" name="degats" class="form-control @error('degats') is-invalid @enderror" rows="3">{{ old('degats') }}</textarea>
                    @error('degats')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="charge" name="charge" class="form-control @error('charge') is-invalid @enderror" value="{{ old('charge') }}">
                    @error('charge')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="perte" name="perte" class="form-control @error('perte') is-invalid @enderror" value="{{ old('perte') }}">
                    @error('perte')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" id="estimation_de_remboursement" name="estimation_de_remboursement" class="form-control @error('estimation_de_remboursement') is-invalid @enderror" value="{{ old('estimation_de_remboursement') }}">
                    @error('estimation_de_remboursement')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>

                <!-- Nature de Sinistre (select) -->
                <div class="form-group">
                    <label for="nature_de_sinistre">Nature de Sinistre</label>
                    <select id="nature_de_sinistre" name="nature_de_sinistre" class="form-control @error('nature_de_sinistre') is-invalid @enderror">
                ...
                <div class="form-group">
                    ...
                    <textarea id="commentaires" name="commentaires" class="form-control @error('commentaires') is-invalid @enderror" rows="3">{{ old('commentaires') }}</textarea>
                    @error('commentaires')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
