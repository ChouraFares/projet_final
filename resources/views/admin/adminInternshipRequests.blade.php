                    ...
                    <tr>
                        ...
                        <td>
                            @if($request->status == 'pending')
                                <form action="{{ route('admin.approveInternshipRequest', $request->id) }}" method="POST" class="d-inline-block">
                                    @csrf
                                    <button type="submit" class="btn btn-success btn-sm custom-btn">
                                        <i class="fas fa-check-circle"></i> Approuver
                                    </button>
                                </form>
                                <form action="{{ route('admin.rejectInternshipRequest', $request->id) }}" method="POST" class="d-inline-block">
                                    @csrf
