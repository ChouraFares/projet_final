    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                <!-- Menu Items -->
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard')); ?>" class="nav-link d-flex flex-column text-center">
                        <i class="fas fa-home fa-lg my-1"></i>
                        <span class="small">Tableau de bord</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="nav-link d-flex flex-column text-center">
                        <i class="fas fa-user-edit fa-lg my-1"></i>
                        <span class="small">Modifier profil</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('change-password')); ?>" class="nav-link d-flex flex-column text-center">
                    ...
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarDropdown" 
                       role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <?php if(Auth::user()->profile_photo): ?>
                            <img src="<?php echo e(asset('storage/' . Auth::user()->profile_photo)); ?>" alt="Photo de profil" class="profile-photo">
                        <?php else: ?>
                            <div class="user-icon-container">
                                <i class="fas fa-user-circle user-icon"></i>
                            </div>
                        <?php endif; ?>
                        <span class="username ms-2"><?php echo e(Auth::user()->name ?? 'Utilisateur'); ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>">Mon profil</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('change-password')); ?>">Paramètres</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <form id="logout-form-dropdown" action="<?php echo e(route('logout')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"><?php /**PATH C:\Users\chofar\Desktop\bk_food_pack\projet_final-master\resources\views/components/navbar.blade.php ENDPATH**/ ?>