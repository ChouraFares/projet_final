...
<body style="transform: scale(0.8); transform-origin: 0 0; width: 125%; height: 125%;">
    <header>
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>">
            <img src="<?php echo e(asset('images/bk-food.png')); ?>" alt="BK FOOD Logo" style="height: 50px; margin-right: 20px;">
        </a>
...
<?php /**PATH C:\Users\chofar\Desktop\bk_food_pack\projet_final-master\resources\views/layouts/app.blade.php ENDPATH**/ ?>