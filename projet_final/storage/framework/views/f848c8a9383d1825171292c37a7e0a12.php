...
<?php $__env->startSection('title', 'Bienvenue sur le Portail BK Food'); ?>
...
<style>
    ...
    .hero::before {
        ...
        right: 0;
        bottom: 0;
        background: url('<?php echo e(asset('images/télécharger__3_-removebg-preview.png')); ?>') no-repeat center center;
...
<div class="homepage-container">
    ...
    <video class="background-video" autoplay muted loop playsinline>
        <source src="<?php echo e(asset('videos/2fd67280-45cf-4863-a17d-f6328ddc48f6.mp4')); ?>" type="video/mp4">
    ...
    <header>
        <a href="/">
            <img src="<?php echo e(asset('images/bk-food.png')); ?>" alt="BK Food Logo">
    ...
    <section class="hero">
        ...
        <div>
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn">Créer un compte</a>
        </div>
    </section>

    <!-- Footer Section -->
    <footer>
        <p>© <?php echo e(date('Y')); ?> BK Food. Tous droits réservés.</p>
        <div>
...
<?php /**PATH C:\Users\chofar\Desktop\bk_food_pack\projet_final-master\resources\views/home.blade.php ENDPATH**/ ?>